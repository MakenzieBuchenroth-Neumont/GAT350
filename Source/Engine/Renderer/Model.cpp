...
namespace nc
{
	...
	bool Model::Load(const std::string& filename, const glm::vec3& translate, const glm::vec3& rotate, const glm::vec3& scale)
	{
		...
		glm::mat4 mr = glm::eulerAngleYXZ(glm::radians(rotate.y), glm::radians(rotate.x), glm::radians(rotate.z));
